            ...
            <div class="row">
                ...
                <div class="kopa-main-col <?php echo $wrap_classes; ?>">                
                    <div class="kopa-entry-post"> 
                        <?php
                        if (have_posts()):
                            $is_enable_featured_content = (int) kopa_get_option('is-enable-post-featured-content', 1);
                            $is_enable_category = (int) kopa_get_option('is-enable-post-category', 1);
                            $is_enable_tag = (int) kopa_get_option('is-enable-post-tag', 1);
                            $is_enable_datetime = (int) kopa_get_option('is-enable-post-created-date', 1);
                            $is_enable_comments = (int) kopa_get_option('is-enable-post-comment-counts', 1);
                            $is_enable_shares = (int) kopa_get_option('is-enable-post-share-buttons', 1);
                            $is_enable_author = (int) kopa_get_option('is-enable-post-author-info', 1);
                                        ...
                                        <div class="content-body">
                                            ...
                                            <?php if ($is_enable_tag && has_tag()): ?>
                                                <div class="kopa-tag-box">    
                                                    <span><?php _e('Tags :', divine_get_domain()); ?></span>
                                                    <?php the_tags('', ', '); ?>                        
                                                </div>
                                            <?php endif; ?>
                                            <?php
