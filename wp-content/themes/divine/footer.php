...
divine_get_footer_social_links();
...
<div id="bottom-sidebar">
    <div class="wrapper">
        <div class="row">
            <?php
            add_filter('dynamic_sidebar_params', 'divine_edit_footer_sidebar');
            ...
            remove_filter('dynamic_sidebar_params', 'divine_edit_footer_sidebar');
            ?>
        </div>
    </div>
</div>
