...
function kopa_font_style_options() {
	return apply_filters( 'kopa_font_style_options', array(
		array (
			'style' => '100',
			'label' => __( 'Thin', kopa_get_domain() ),
		),
		array (
			'style' => '100italic',
			'label' => __( 'Thin/Italic', kopa_get_domain() ),
		),
		array (
			'style' => '200',
			'label' => __( 'Extra-Light', kopa_get_domain() ),
		),
		array (
			'style' => '200italic',
			'label' => __( 'Extra-Light/Italic', kopa_get_domain() ),
		),
		array (
			'style' => '300',
			'label' => __( 'Light', kopa_get_domain() ),
		),
		array (
			'style' => '300italic',
			'label' => __( 'Light/Italic', kopa_get_domain() ),
		),
		array (
			'style' => '400',
			'label' => __( 'Normal', kopa_get_domain() ),
		),
		array (
			'style' => '400italic',
			'label' => __( 'Normal/Italic', kopa_get_domain() ),
		),
		array (
			'style' => 'regular',
			'label' => __( 'Normal', kopa_get_domain() ),
		...
		array (
			'style' => '500',
			'label' => __( 'Medium', kopa_get_domain() ),
		),
		array (
			'style' => '500italic',
			'label' => __( 'Medium/Italic', kopa_get_domain() ),
		),
		array (
			'style' => '600',
			'label' => __( 'Semi-Bold', kopa_get_domain() ),
		),
		array (
			'style' => '600italic',
			'label' => __( 'Semi-Bold/Italic', kopa_get_domain() ),
		),
		array (
			'style' => '700',
			'label' => __( 'Bold', kopa_get_domain() ),
		),
		array (
			'style' => '700italic',
			'label' => __( 'Bold/Italic', kopa_get_domain() ),
		),
		array (
			'style' => 'bold',
			'label' => __( 'Bold', kopa_get_domain() ),
		...
		array (
			'style' => '800',
			'label' => __( 'Extra-Bold', kopa_get_domain() ),
		),
		array (
			'style' => '800italic',
			'label' => __( 'Extra-Bold/Italic', kopa_get_domain() ),
		),
		array (
			'style' => '900',
			'label' => __( 'Ultra-Bold', kopa_get_domain() ),
		),
		array (
			'style' => '900italic',
			'label' => __( 'Ultra-Bold/Italic', kopa_get_domain() ),
		),
	) );
}
